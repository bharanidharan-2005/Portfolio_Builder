...
script_content = """import { PORTFOLIO_THEMES, PORTFOLIO_FONTS } from '../canvas/themes';
...
print("Export HTML updated with exact Description scraping, fallback 'See Live' buttons, and Classic Premium Animations.")
