                        ...
                        {stepState === "name" && authMode === "signup" && (
                            <form onSubmit={handleNameSubmit} className="w-full space-y-5 animate-in slide-in-from-right-4">
                                ...
                                <div className="relative flex py-4 items-center">
                                    ...
                                    <span className="flex-shrink-0 mx-4 text-slate-500 text-xs font-bold uppercase">Or continue with</span>
                                    <div className="flex-grow border-t border-slate-700"></div>
                                </div>
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <button type="button" onClick={handleGithubLogin} className="w-full py-2.5 rounded-full bg-[#24292F] hover:bg-[#24292F]/80 text-white text-sm font-bold transition-all flex justify-center items-center gap-2 cursor-pointer border border-slate-700">
